 ...
 */
    ...
    class dzialanie_uzytkownik_kontaktPage extends Page
    {
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_list');
            $column->setMinimalVisibility(ColumnVisibility::PHONE);
            $column->SetDescription('');
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        protected function AddSingleRecordViewColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_view');
            $grid->AddSingleRecordViewColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_view');
            $grid->AddSingleRecordViewColumn($column);
        }
        ...
        protected function AddPrintColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_print');
            $grid->AddPrintColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_print');
            $grid->AddPrintColumn($column);
        }
        ...
        protected function AddExportColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_export');
            $grid->AddExportColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_export');
            $grid->AddExportColumn($column);
        }
        ...
        private function AddCompareColumns(Grid $grid)
        {
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_compare');
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_compare');
            $grid->AddCompareColumn($column);
            ...
            $column->SetOrderable(true);
            $column->SetMaxLength(75);
            $column->SetFullTextWindowHandlerName('dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_compare');
            $grid->AddCompareColumn($column);
        }
        ...
        protected function doRegisterHandlers() {
            ...
            $column = new TextViewColumn('id_kontakt', 'id_kontakt_imie', 'Id Kontakt', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_list', $column);
            ...
            $column = new TextViewColumn('id_uzytkownik', 'id_uzytkownik_email', 'Id Uzytkownik', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_dzialanie', 'id_dzialanie_rodzaj', 'Id Dzialanie', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_list', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_kontakt', 'id_kontakt_imie', 'Id Kontakt', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_uzytkownik', 'id_uzytkownik_email', 'Id Uzytkownik', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_dzialanie', 'id_dzialanie_rodzaj', 'Id Dzialanie', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_print', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_kontakt', 'id_kontakt_imie', 'Id Kontakt', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_uzytkownik', 'id_uzytkownik_email', 'Id Uzytkownik', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_dzialanie', 'id_dzialanie_rodzaj', 'Id Dzialanie', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_compare', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_kontakt', 'id_kontakt_imie', 'Id Kontakt', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_kontakt_imie_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_uzytkownik', 'id_uzytkownik_email', 'Id Uzytkownik', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_uzytkownik_email_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
            ...
            $column = new TextViewColumn('id_dzialanie', 'id_dzialanie_rodzaj', 'Id Dzialanie', $this->dataset);
            $column->SetOrderable(true);
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'dzialanie_uzytkownik_kontaktGrid_id_dzialanie_rodzaj_handler_view', $column);
            GetApplication()->RegisterHTTPHandler($handler);
    ...
    try
    {
        $Page = new dzialanie_uzytkownik_kontaktPage("dzialanie_uzytkownik_kontakt", "dzialanie_uzytkownik_kontakt.php", GetCurrentUserPermissionSetForDataSource("dzialanie_uzytkownik_kontakt"), 'UTF-8');
        $Page->SetTitle('Dzialanie Uzytkownik Kontakt');
        $Page->SetMenuLabel('Działanie-Użytkownik-Kontakt');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("dzialanie_uzytkownik_kontakt"));
